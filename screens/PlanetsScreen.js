...
import { useNavigation } from '@react-navigation/native'; // To navigate to the detail screen
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        {filteredData.map((planet, index) => (
          <Swipeable
            key={index}
            renderLeftActions={() => <Text style={styles.swipeText}>Swipe left to view details</Text>}
            onSwipeableLeftOpen={() => navigation.navigate('PlanetDetail', { planetId: planet.uid })} // Navigate to detail page
          >
