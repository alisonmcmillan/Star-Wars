  ...
  if (!isConnected) {
    return (
      <View style={styles.container}>
        <Text style={styles.errorText}>No internet connection. Please check your network and try again.</Text>
      </View>
    );
  }
