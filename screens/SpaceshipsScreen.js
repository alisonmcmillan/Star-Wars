...
import { View, Text, StyleSheet, ActivityIndicator, ScrollView, Modal, Button, Animated, Image } from 'react-native';
import { Swipeable } from 'react-native-gesture-handler';
import SearchInput from '../SearchInput'; // Ensure this component is available
...
const SpaceshipsScreen = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://www.swapi.tech/api/starships/?search=${searchTerm}`)
      ...
      .then((data) => {
        ...
        // Trigger fade-in animation after data is fetched
  ...
  const handleSearch = (term) => {
    ...
    // Reset animation when new search is initiated
    fadeAnim.setValue(0);
  };
